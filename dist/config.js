 ...
 */
function readSecret(envKey, fileKey) {
...
export const TRIGGER_PATTERN = new RegExp(`^(?:@)?${escapeRegex(TRIGGER_WORD)}\\b`, 'i');
// Timezone for scheduled tasks (cron expressions, etc.)
// Uses system timezone by default
export const TIMEZONE = process.env.TZ || Intl.DateTimeFormat().resolvedOptions().timeZone;
// Platform configuration
export const MESSENGER_PLATFORM = process.env.MESSENGER_PLATFORM || envConfig.MESSENGER_PLATFORM || 'whatsapp';
// Telegram configuration
export const TELEGRAM_BOT_TOKEN = readSecret('TELEGRAM_BOT_TOKEN', 'TELEGRAM_BOT_TOKEN_FILE');
// Telegram policies
export const TELEGRAM_ALLOWED_USERS = (process.env.TELEGRAM_ALLOWED_USERS || envConfig.TELEGRAM_ALLOWED_USERS || '')
    .split(',')
    .map((s) => s.trim())
    .filter(Boolean);
export const TELEGRAM_DM_POLICY = process.env.TELEGRAM_DM_POLICY || envConfig.TELEGRAM_DM_POLICY || 'closed';
export const TELEGRAM_GROUP_POLICY = process.env.TELEGRAM_GROUP_POLICY || envConfig.TELEGRAM_GROUP_POLICY || 'closed';
...
export const TELEGRAM_ONLY = telegramOnlyEnv !== undefined
