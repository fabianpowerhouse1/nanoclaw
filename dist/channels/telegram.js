...
import { ASSISTANT_NAME, TELEGRAM_ALLOWED_USERS, TELEGRAM_DM_POLICY, TELEGRAM_GROUP_POLICY, TRIGGER_PATTERN, } from '../config.js';
...
export class TelegramChannel {
    ...
    async connect() {
        ...
        this.bot.on('message:text', async (ctx) => {
            ...
            if (ctx.message.text.startsWith('/') && !isIsolationCommand)
                return;
            ...
            this.opts.onChatMetadata(chatJid, timestamp, chatName, 'telegram', ctx.chat.type !== 'private');
